  ...
  return (
    <>
              ...
              {item ? <div>
                <div className='Item_About'>
                  ...
                  <div style={{ marginTop: 20 }}>
                    ...
                    <div onClick={onProfileClick} style={{ marginTop: "20px" }} >👤{item.writer.nickname}</div>
                  </div>
      ...
      <div className="Comment">
        <HorizonLine />
        <div className="CommentForm" style={centerStyle}>
          <h3 style={{ padding: "20px" }}>댓글</h3>
          <form className="CommentInsert" onSubmit={onSubmit}
            ...
            />
            <button type="submit" style={{ border: 'none', padding: "10px", marginLeft: "10px" }}>보내기</button>
          </form>
        </div>
      </div>
    </>
