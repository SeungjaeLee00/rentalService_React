...
export default function RentModal(props) {
    ...
    const DeleteTrade = () => {
        axios.delete(`/api/trades/${tradeinfo.tradeId}`, {
            headers: {
                'Authorization': `Bearer ${actoken}`,
                'Auth': retoken
            }
            ...
            <div className="RentmodalBody" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="RentModal-content">
                    ...
                    <div className="Rent-date">
                        <span>대여기간 : </span>
                        <DateSpan>{tradeinfo.startDate[0] + "년" + tradeinfo.startDate[1] + "월" + tradeinfo.startDate[2] + "일"} ~
                            {tradeinfo.endDate[0] + "년" + tradeinfo.endDate[1] + "월" + tradeinfo.endDate[2] + "일"}</DateSpan>
                    </div>
                    <div>
